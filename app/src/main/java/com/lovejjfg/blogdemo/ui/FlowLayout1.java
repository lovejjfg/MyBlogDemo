...
public class FlowLayout1 extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childWidth = width / DefaultRows;
        Log.e("width", width + "");
        Log.i("childWidth应该是：", childWidth + "");
...
//            child.measure(childWidthMeasureSpec, childHeightMeasureSpec);
            ...
            int childWidthSpec = getChildMeasureSpec(
                    MeasureSpec.makeMeasureSpec(width / DefaultRows, MeasureSpec.EXACTLY), 0, p.width);
            ...
            int realChildWidth = child.getMeasuredWidth();
            Log.e("realChildWidth", realChildWidth + "");
