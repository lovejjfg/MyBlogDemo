...
//    private TextView mFooterUpdateTextView;
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.layout_header_view, this, false);
...
//        mHeaderUpdateTextView = (TextView) mHeaderView.findViewById(R.id.pull_to_refresh_updated_at);
    ...
    private void addFooterView() {
        // footer view
//        mFooterView = mInflater.inflate(R.layout.layout_header_view, this, false);
...
//                // finish later
//                mScrollView = (android.support.v4.widget.NestedScrollView) view;
//            }
        }
...
//            View child = mScrollView.getChildAt(0);
            Log.e(TAG, "isRefreshViewScroll: " + mScrollView.getScrollY());
...
//        setLastUpdated(lastUpdated);
    ...
    public void onHeaderRefreshError(String error) {
//        headerRefreshing();
        mHeaderProgressBar.setVisibility(View.GONE);
        mHeaderImageView.setVisibility(View.INVISIBLE);
        mHeaderTextView.setText(error);
...
//        public void onFooterRefresh(PullToRefreshView view);
    ...
    public interface OnHeaderRefreshListener {
        void onHeaderRefresh(HeaderView view);
