...
//        }
    ...
    public void setRadiusRatio(int mRadiusRatio) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCentered) {
            longOffset += (longSize - longPaddingBefore - longPaddingAfter - (count * mRectWidth) - (count - 1) * rectOffset) / 2.0f;
        }
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            RectF rectF = new RectF(dX - pageFillRadius, dY - pageFillRadius, dX + pageFillRadius, dY + pageFillRadius);
...
//                canvas.drawCircle(dX, dY, pageFillRadius, mPaintPageFill);
    ...
    private int measureLong(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            result = (int) (getPaddingLeft() + getPaddingRight()
                    + (count * mRectWidth) + (count - 1) * (mRectWidth / 2.0f) + 1);
    ...
    private int measureShort(int measureSpec) {
        ...
        if (specMode == MeasureSpec.EXACTLY) {
            ...
            //Measure the height
            result = (int) (mRectWidth + getPaddingTop() + getPaddingBottom() + 1);
            //Respect AT_MOST value if that was what is called for by measureSpec
            if (specMode == MeasureSpec.AT_MOST) {
                result = Math.min(result, specSize);
            }
