...
package com.lovejjfg.blogdemo.utils.crop;
...
class HighlightView {
    ...
    public Rect getScaledCropRect(int scale) {
        Rect rect = new Rect();
        for (int i = 1; i <= scale; i++) {
            if ((cropRect.right-cropRect.left)*i>=1000||(cropRect.bottom-cropRect.top)*i>=1000) {
//                rect.set((int) (cropRect.left*i), (int) (cropRect.top*i),
//                        (int) (cropRect.right*i), (int) (cropRect.bottom*i));
                currentScale = i;
                break;
            }
        }
        rect.set((int) (cropRect.left*scale), (int) (cropRect.top*scale),
